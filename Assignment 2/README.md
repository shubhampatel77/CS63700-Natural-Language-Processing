This assignment is focussed on implementing the Vector Space Model (VSM) as well as some evaluation techniques like precison, recall, nDCG, F scores, mean average precision.
